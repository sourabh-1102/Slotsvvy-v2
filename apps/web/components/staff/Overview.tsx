...
// Simple Stat Card
function StatCard({ title, value, subtext, type = 'neutral', onClick }: any) {
    const colors = {
...
export default function Overview({ setActiveTab, parcels, setFilters }: { setActiveTab: (t: string) => void, parcels: any[], setFilters: any }) {
