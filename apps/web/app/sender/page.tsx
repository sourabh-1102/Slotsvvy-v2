...
import { createParcel, getRecommendedSlots } from '../../components/api';
...
export default function SenderPage() {
  ...
  const [slots, setSlots] = useState<any[]>(MOCK_SLOTS); // Default to mock for UI dev
  ...
  const handleSubmit = async () => {
    ...
    try {
        ...
        const payload = {
            ...form,
            slot: selectedSlotData?.label // Send readable label like "8:00 - 10:00 PM"
        };
